...
@WebServlet(name = "GameExcluir", urlPatterns = {"/GameExcluir"})
public class GameExcluir extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (dao.excluir(idGame)) {
                mensagem = "Game excluido com Sucesso!";
            } else {
                mensagem = "Problemas ao excluir Game";
            }
