...
@WebServlet(name = "PlataformaListar", urlPatterns = {"/PlataformaListar"})
public class PlataformaListar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("plataformas", dao.listar());
            request.getRequestDispatcher("/cadastros/plataforma/plataforma.jsp").forward(request, response);
        } catch (Exception ex) {
