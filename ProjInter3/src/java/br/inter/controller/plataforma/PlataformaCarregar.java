...
@WebServlet(name = "PlataformaCarregar", urlPatterns = {"/PlataformaCarregar"})
public class PlataformaCarregar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("plataforma", dao.carregar(idPlataforma));
            request.getRequestDispatcher("/cadastros/plataforma/PlataformaCadastrar.jsp").forward(request, response);
        } catch (Exception e) {
